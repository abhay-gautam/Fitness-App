...
public class  Shoulders extends AppCompatActivity {
    private static final String TAG = "Shoulders";
    FitnessInterface fitnessInterface;
    ImageView imageView;


    private static final String urlshoulders= "https://fitness777.000webhostapp.com/api/images/";
    ...
    private void getshoulders() {
        ...
        call.enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, Response<Example> response) {
                ...
                adapter = new Adapter(Shoulders.this,record);
