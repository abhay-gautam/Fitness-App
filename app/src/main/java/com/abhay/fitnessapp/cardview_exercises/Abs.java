...
public class  Abs extends AppCompatActivity {
    ...
    private static final String urlAbs= "https://fitness777.000webhostapp.com/api/images/";
    ...
    private void getAbs() {
        Call<Example> call = fitnessInterface.getAbs();
        ...
        call.enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, Response<Example> response) {
                ...
                adapter = new Adapter(Abs.this,record);
