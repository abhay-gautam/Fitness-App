...
public class  Legs extends AppCompatActivity {
    ...
    private static final String urllegs= "https://fitness777.000webhostapp.com/api/images/";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setImageResource(R.drawable.gym_l);
        imageView=findViewById(R.id.imageinlist);
        imageView.setImageResource(R.drawable.gym_h);
    ...
    private void getlegs() {
        ...
        call.enqueue(new Callback<Example>() {
            ...
            public void onResponse(Call<Example> call, Response<Example> response) {
                ...
                adapter = new Adapter(Legs.this,record);
